...
2. Дай 1-2 конкретні позитивні коментарі щодо виконання (на основі AI відгуку, якщо є)
3. Повідом, що плануємо технічну співбесіду і менеджер зв'яжеться найближчим часом
