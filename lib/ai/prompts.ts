...
3. Згадай, що кандидат може ставити питання про деталі вакансії прямо тут у чаті — ми постараємося відповісти
4. Згадай, що після невеликої анкети на наступний крок чекає тестове завдання
5. Загальна довжина: 3-5 речень максимум
6. Закінчуй нейтрально, БЕЗ call-to-action (кнопка буде додана окремо)
7. НЕ підписуй повідомлення
8. Звертайся на "ти"
